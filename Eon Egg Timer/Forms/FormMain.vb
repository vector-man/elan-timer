...
#End If
    ...
    Private Sub SaveSettings()
        ...
        Catch ex As Exception
            ...
            If MessageBox.Show("Eon Egg Timer failed to save one or more settings files. Would you like to try again? If you select ""No,"" Some changes since you last ran Eon Egg Timer will be lost.", My.Application.Info.AssemblyName, MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
                SaveSettings()
            End If
        End Try
    End Sub
...
#End Region
    ...
    Private Sub AboutEggzeyToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ToolStripMenuItemAboutEonEggTimer.Click
