Public Class RendererManager
    ...
    Private _renderer As EggzleLib.Extend.Renderers.IRenderer
    ...
    Sub New(ByRef renderer As EggzleLib.Extend.Renderers.IRenderer, ByRef context As Object, ByRef surface As PictureBox, previewMode As Boolean)
        MyClass.New(renderer, context, surface, previewMode, DefaultRenderRate)
    End Sub
    Sub New(ByRef renderer As EggzleLib.Extend.Renderers.IRenderer, ByRef context As Object, ByRef surface As PictureBox, previewMode As Boolean, renderRate As Integer)
        _surface = surface
        _context = context
        _renderer = renderer
    ...
    Private Sub Surface_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        _renderer.Render(e, _surface.DisplayRectangle.Size)
